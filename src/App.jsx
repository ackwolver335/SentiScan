...
function App() {
  ...
  if(loading){
    return <div className="loader xsz:text-base lg:text-lg xl:text-xl font-bold font-serif animate-pulse "> Sentiment is <TypeTesting /> </div>       // component containing loading animation
  }
