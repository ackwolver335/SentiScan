...
export default function Features() {
    return (
        <div className="xsz:px-5 xsz:py-6 flex flex-col xsz:gap-3 z-10 bg-white">

            {/* Initial Block of Heading */}
            <div className="headingBlock flex flex-row justify-between">

                {/* Main Heading regarding the Features's Section */}
                <h2 className="xsz:text-lg font-merriweather xsz:font-bold text-indigo"> Features Scales </h2>

                {/* Icon regarding Features of this Web-App */}
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-pencil-square xsz:w-5 text-indigo " viewBox="0 0 16 16">
            ...
            <div className="featureCards grid xsz:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xsz:gap-6 md:gap-8 3xl:gap-10 xsz:px-2 xsz:py-4">
                ...
                <div className="imageCard flex flex-col items-center xsz:shadow-md lg:hover:shadow-indigo-500 lg:hover:shadow-xl xsz:px-2 xsz:py-4 xsz:rounded-lg lg:scale-90 hover:scale-100 ease-out md:gap-3 duration-100 xsz:gap-2">
                    <img src = {RealTimeAnalysis} alt = "Feature - Real Time Analysis" className = "xsz:w-2/3 rounded-t-md" />
                    <h2 className = "font-merriweather text-secondary xsz:font-semibold xsz:text-[15px]"> Real Time Analysis </h2>
                    <p className = "font-inter xsz:text-[11px]">
                ...
                <div className="imageCard flex flex-col items-center xsz:shadow-md lg:hover:shadow-indigo-500 lg:hover:shadow-xl xsz:px-2 xsz:py-4 xsz:rounded-lg lg:scale-90 hover:scale-100 ease-out md:gap-3 duration-100 xsz:gap-2">
                    ...
                    <h2 className = "font-merriweather text-secondary xsz:font-semibold xsz:text-[15px]"> Multi-Emotion Detection </h2>
                    <p className = "font-inter xsz:text-[11px]">
                ...
                <div className="imageCard flex flex-col items-center xsz:shadow-md lg:hover:shadow-indigo-500 lg:hover:shadow-xl xsz:px-2 xsz:py-4 xsz:rounded-lg lg:scale-90 hover:scale-100 ease-out md:gap-3 duration-100 xsz:gap-2">
                    ...
                    <h2 className = "font-merriweather text-secondary xsz:font-semibold xsz:text-[15px]"> Score Based Insights </h2>
                    <p className = "font-inter xsz:text-[11px]">
                ...
                <div className="imageCard flex flex-col items-center xsz:shadow-md lg:hover:shadow-indigo-500 lg:hover:shadow-xl xsz:px-2 xsz:py-4 xsz:rounded-lg lg:scale-90 hover:scale-100 ease-out md:gap-3 duration-100 xsz:gap-2">
                    ...
                    <h2 className = "font-merriweather text-secondary xsz:font-semibold xsz:text-[15px]"> Clean UI </h2>
                    <p className = "font-inter xsz:text-[11px]">
                ...
                <div className="imageCard flex flex-col items-center xsz:shadow-md lg:hover:shadow-indigo-500 lg:hover:shadow-xl xsz:px-2 xsz:py-4 xsz:rounded-lg lg:scale-90 hover:scale-100 ease-out md:gap-3 duration-100 xsz:gap-2">
                    ...
                    <h2 className = "font-merriweather text-secondary xsz:font-semibold xsz:text-[15px]"> Mobile Friendly </h2>
                    <p className = "font-inter xsz:text-[11px]">
                ...
                <div className="imageCard flex flex-col items-center xsz:shadow-md lg:hover:shadow-indigo-500 lg:hover:shadow-xl xsz:px-2 xsz:py-4 xsz:rounded-lg lg:scale-90 hover:scale-100 ease-out md:gap-3 duration-100 xsz:gap-2">
                    ...
                    <h2 className = "font-merriweather text-secondary xsz:font-semibold xsz:text-[15px]"> Privacy First </h2>
                    <p className = "font-inter xsz:text-[11px]">
