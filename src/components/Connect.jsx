            ...
            <div className="contactInfo flex flex-col items-start xsz:gap-4 lg:gap-5 xsz:px-3">
                ...
                <div className="flex flex-col items-start xsz:gap-2 lg:gap-4">
                    ...
                    <div className="iconsLinks flex flex-row items-center xsz:gap-3 lg:gap-4">
                        ...
                        {/* Twitter */}
                        <a href="https://x.com/AbhayCh84760" className="bg-blue-200 text-blue-600 xsz:p-2 lg:p-3 xsz:rounded-full lg:hover:bg-blue-600 lg:hover:text-white ease-in duration-150" target = "_blank">
                        ...
                        {/* LinkdIn */}
                        <a href="https://www.linkedin.com/in/abhaychaudhary335/" className="bg-blue-200 text-blue-600 xsz:p-2 lg:p-3 xsz:rounded-full lg:hover:bg-blue-600 lg:hover:text-white ease-in duration-150" target = "_blank">
                        ...
                        {/* Instagram */}
                        <a href="https://www.instagram.com/being_chaudhary.ig/" className="bg-blue-200 text-blue-600 xsz:p-2 lg:p-3 xsz:rounded-full lg:hover:bg-blue-600 lg:hover:text-white ease-in duration-150" target = "_blank">
                        ...
                        {/* Facebook */}
                        <a href="https://www.facebook.com/coding.needs/" className="bg-blue-200 text-blue-600 xsz:p-2 lg:p-3 xsz:rounded-full lg:hover:bg-blue-600 lg:hover:text-white ease-in duration-150" target = "_blank">
