...
export default function NavDirect() {
	...
	return (
		<div className="fixed z-20 flex flex-row justify-between items-center xsz:top-1 xsz:right-1 xsz:left-1 sm:right-2 sm:left-2 xl:top-3 xl:left-5 xl:right-5 bg-linear-to-br from-indigo/70 to-blue-500/70 xsz:m-3 xsz:p-3 sm:p-4 xl:px-5 xl:py-3 lg:rounded-xl xsz:rounded-md xsz:backdrop-blur-md lg:backdrop-blur-lg xsz:shadow-md xl:shadow-lg">
