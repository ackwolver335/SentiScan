...
export default function SentiIntro() {
  return (
    <div className = "flex flex-col xsz:py-14 xsz:px-5 xsz:gap-7 lg:gap-10">
        ...
        <div className="flex xsz:flex-col lg:flex-row xsz:justify-center lg:justify-evenly items-center xsz:gap-5 sm:gap-6 lg:gap-10 xl:gap-14 lg:px-5 2xl:px-7">
          ...
          {/* Positive Sentiment */}
          <div className="flex flex-col xsz:gap-3 xl:gap-4 items-start bg-blue-200 xsz:px-5 xsz:py-4 xsz:rounded-md sm:w-2/3 md:w-3/5 lg:w-fit hover:-translate-y-2 lg:hover:shadow-lg ease-in-out duration-150">
          ...
          {/* Neutral Sentiment */}
          <div className="flex flex-col xsz:gap-3 xl:gap-4 items-start bg-yellow-100 xsz:px-5 xsz:py-4 xsz:rounded-md sm:w-2/3 md:w-3/5 lg:w-fit hover:-translate-y-2 lg:hover:shadow-lg ease-in-out duration-150">
          ...
          {/* Negative Sentiment */}
          <div className="flex flex-col xsz:gap-3 xl:gap-4 items-start bg-red-200 xsz:px-5 xsz:py-4 xsz:rounded-md sm:w-2/3 md:w-3/5 lg:w-fit hover:-translate-y-2 lg:hover:shadow-lg ease-in-out duration-150">
