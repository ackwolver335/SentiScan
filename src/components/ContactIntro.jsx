...
export default function ContactIntro() {
    return (
        <div className = "xsz:pt-22 sm:pt-30 xsz:pb-10 lg:pb-16 xl:pb-20 xsz:px-6 lg:px-12 lg:pt-36 flex xsz:flex-col xsz:gap-5 md:flex-row xsz:items-center lg:justify-center xl:gap-12 md:items-start bg-linear-to-br from-[#3b81f5] to-[#9234ea]">
